...
CREATE INDEX IF NOT EXISTS "idx_applications_worker_id" ON "applications" ("worker_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_applications_status" ON "applications" ("status");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "unique_job_worker" ON "applications" ("job_id","worker_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_jobs_poster_id" ON "jobs" ("poster_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_jobs_worker_id" ON "jobs" ("worker_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_jobs_status" ON "jobs" ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_jobs_location" ON "jobs" ("location_lat","location_lng");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_jobs_category" ON "jobs" ("category");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_jobs_skills" ON "jobs" ("required_skills");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_payments_job_id" ON "payments" ("job_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_payments_poster_id" ON "payments" ("poster_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_payments_worker_id" ON "payments" ("worker_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_payments_status" ON "payments" ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_payments_stripe_payment_intent" ON "payments" ("stripe_payment_intent_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_worker_profiles_user_id" ON "worker_profiles" ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_worker_profiles_location" ON "worker_profiles" ("location_lat","location_lng");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_worker_profiles_skills" ON "worker_profiles" ("skills");--> statement-breakpoint
DO $$ BEGIN
